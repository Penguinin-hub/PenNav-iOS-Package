...
3. Click **Add Package**
4. When prompted, add **PenNav** to your target. Optionally add **PenNavRoaming** to enable off-campus navigation.
...
## Migration to v5.0
When upgrading to v5.0 or later from older versions, follow these steps:
