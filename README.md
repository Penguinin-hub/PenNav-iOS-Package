...
3. In the version options, select **Exact Version** and enter: 5.0.3
4. Click **Add Package**
5. When prompted, add **PenNav** to your target. Optionally add **PenNavRoaming** to enable off-campus navigation.
> **Note:** Mapbox SDKs are bundled in v5.0.3+, so you do **not** need to install Mapbox separately.
...
## Migration to v5.0.3
When upgrading to v5.0.3 or later from older versions, follow these steps:
